...
app.layout = html.Div(
    ...
    dcc.Store(id = "dataframe-store-full", data = df.to_dict('records')),  # Store full dataframe as dict for reference
...
def update_app(sales_clicks, asset_clicks, borrow_clicks, shrink_clicks, 
               ...
               page, df, df_full, click_data, step, selected_geography,
...
#     ]
# )
# def toggle_hotzones(show_hotzones, step, selected_geography):
...
#         elif selected_geography["Country"] in GPlots.nuts_countries:
#             if show_hotzones:
#                 fig = GPlots.plot_nuts_country_hotzones(selected_geography["Country"], nuts1_rates_metadata, 1, APP_BACKGROUND_COLOR)
#             else:
#                 fig = GPlots.plot_nuts_country(selected_geography["Country"], 1, background_color = APP_BACKGROUND_COLOR)
...
#         elif selected_geography["Country"] in GPlots.nuts_countries:
#             if show_hotzones:
#                 fig = GPlots.plot_nuts_country_hotzones(selected_geography["Country"], nuts2_rates_metadata, 2, selected_geography["NUTS1"], APP_BACKGROUND_COLOR)
#             else:
#                 fig = GPlots.plot_nuts_country(selected_geography["Country"], 2, selected_geography["NUTS1"], background_color = APP_BACKGROUND_COLOR)
